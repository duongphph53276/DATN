...
import goodProduct from "../../../../mock/goodProducts";
...
const GoodSection  = () => (
  <section className="py-10 bg-white">
    <h2 className="text-center text-rose-500 font-bold text-3xl mb-6">GẤU BÔNG TỐT NGHIỆP </h2>
    <div className="flex flex-wrap justify-center gap-6 px-4">
      {goodProduct.map((product, i) => (
        <Good key={i} {...product} />
      ))}
    </div>
  </section>
